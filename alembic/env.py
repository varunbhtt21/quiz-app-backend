...
from app.core.database import clean_database_url
...
def get_database_url():
    ...
    db_url = getattr(settings, 'direct_url', None) or settings.database_url
    return clean_database_url(db_url)
...
def run_migrations_offline() -> None:
    ...
    context.configure(
        ...
        # Ensure timezone-aware operations
        compare_type=True,
